...
function main() {
    ...
    var poly = [{x:0,y:0,z:10,c:new Color(255,0,0,255)}, {x:-5,y:5,z:10,c:new Color(0,255,0,255)}, 
                {x:-10,y:0,z:10,c:new Color(0,0,0,255)}, {x:-5,y:-5,z:10,c:new Color(0,0,255,255)}];
    ...
    var testAt2 = Vector.subtract(new Vector(0,0,10),testEye2);
    var view2 = {eye:testEye, at:testAt2, up:new Vector(0,1,0)};
    var poly2 = [{x:1,y:5,z:8,c:new Color(255,0,0,255)}, {x:11,y:5,z:12,c:new Color(0,255,0,255)}, 
                {x:11,y:-5,z:12,c:new Color(0,0,0,255)}, {x:1,y:-5,z:10, c:new Color(0,0,255,255)}];
